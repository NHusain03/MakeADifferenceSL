            ...
            <div className='absolute top-0 left-0 w-full h-full flex items-center justify-center drop-shadow-lg'>
                <div className="w-1/3 p-6 bg-slred rounded-lg">
                    ...
                    <div className='flex items-center justify-center'>
                        <a href='#' className="text-decoration-none inline-flex items-center px-3 py-2 text-base font-medium text-center text-slred bg-slyellow rounded-lg border-2 border-transparent hover:bg-slred hover:text-slyellow hover:border-slyellow transition-colors duration-300 ease-in-out-quad">
                            DONATE
                        </a>
                    </div>
                </div>
