  ...
  return (
    <div className='flex justify-center bg-offwhite'>
      <div className='p-10 sm:w-2/3'>
        ...
        <div className='flex flex-col justify-center rounded-lg bg-gray-100 drop-shadow-lg mt-3 lg:flex-row'>
          <img src='/carousel/3.jpg' className='rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg lg:w-1/2'/>
          <div className='lg:w-1/2'>
            <p className="text-gray-700 p-3 text-justify lg:text-left">
